...
export const ResetPass = () => {
  ...
  const updatePass=async(e)=>{
    ...
    try{
        const res = await apiClient.put('/update-pass',payload);
        if(res?.data?.ack==1) nav("/login")
    }
    catch(e){
        console.log(e)
    }
  ...
  return (
    ...
    >
      ...
      <h3 style={{ textAlign: "center" }}>Reset Form</h3>
      <form>
        ...
        <label htmlFor="username">
          ...
          <button
            ...
            className="log"
            onClick={updatePass}
            //   onClick={(e)=>logIn(e,setError,nav,user)}
          >
            Reset
          </button>
        </div>
